...
void	basic(void)
{
	...
	ft_printf("'#' flag |%##x|\n", n);
	printf("'#' flag |%##x|\n", n);
	ft_printf("ft_printf: Triple percent: |%%%|\n", n);
	printf("Triple percent: |%%%|\n", n);
